		...
		new \Kirki\Field\Color(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Color', 'restaurant-elementor' ),
		...
		new \Kirki\Field\Image(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Image', 'restaurant-elementor' ),
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Repeat', 'restaurant-elementor' ),
					'section'     => $args['section'],
					'default'     => isset( $args['default']['background-repeat'] ) ? $args['default']['background-repeat'] : '',
					'choices'     => [
						'no-repeat' => esc_html__( 'No Repeat', 'restaurant-elementor' ),
						'repeat'    => esc_html__( 'Repeat All', 'restaurant-elementor' ),
						'repeat-x'  => esc_html__( 'Repeat Horizontally', 'restaurant-elementor' ),
						'repeat-y'  => esc_html__( 'Repeat Vertically', 'restaurant-elementor' ),
					],
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Position', 'restaurant-elementor' ),
					'default'     => isset( $args['default']['background-position'] ) ? $args['default']['background-position'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'left top'      => esc_html__( 'Left Top', 'restaurant-elementor' ),
						'left center'   => esc_html__( 'Left Center', 'restaurant-elementor' ),
						'left bottom'   => esc_html__( 'Left Bottom', 'restaurant-elementor' ),
						'center top'    => esc_html__( 'Center Top', 'restaurant-elementor' ),
						'center center' => esc_html__( 'Center Center', 'restaurant-elementor' ),
						'center bottom' => esc_html__( 'Center Bottom', 'restaurant-elementor' ),
						'right top'     => esc_html__( 'Right Top', 'restaurant-elementor' ),
						'right center'  => esc_html__( 'Right Center', 'restaurant-elementor' ),
						'right bottom'  => esc_html__( 'Right Bottom', 'restaurant-elementor' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Size', 'restaurant-elementor' ),
					'default'     => isset( $args['default']['background-size'] ) ? $args['default']['background-size'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'cover'   => esc_html__( 'Cover', 'restaurant-elementor' ),
						'contain' => esc_html__( 'Contain', 'restaurant-elementor' ),
						'auto'    => esc_html__( 'Auto', 'restaurant-elementor' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'description' => esc_html__( 'Background Attachment', 'restaurant-elementor' ),
					'label'       => '',
					'default'     => isset( $args['default']['background-attachment'] ) ? $args['default']['background-attachment'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'scroll' => esc_html__( 'Scroll', 'restaurant-elementor' ),
						'fixed'  => esc_html__( 'Fixed', 'restaurant-elementor' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
