...
class L10n {
	 ...
	 * @access public
	 * @since 1.0
	 * @param string $textdomain     The textdomain we want to use. Defaults to "restaurant-elementor".
	 * @param string $languages_path The path to languages files.
	 */
	public function __construct( $textdomain = 'restaurant-elementor', $languages_path = '' ) {
