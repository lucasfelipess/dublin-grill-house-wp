		...
		<div class="heatbox-header heatbox-has-tab-nav heatbox-margin-bottom">
			...
			<div class="heatbox-container heatbox-container-center">
				...
				<div class="logo-container">
					...
					<div>
						<span class="title">
							<?php _e( 'Kirki Customizer Framework', 'restaurant-elementor' ); ?>
							<span class="version"><?php echo esc_html( KIRKI_VERSION ); ?></span>
						</span>
						<p class="subtitle"><?php _e( 'The #1 Customizer Toolkit for WordPress Theme Developers.', 'restaurant-elementor' ); ?></p>
					</div>
				...
				<nav>
					<ul class="heatbox-tab-nav">
						<li class="heatbox-tab-nav-item kirki-settings-panel">
							<a href="#settings"><?php _e( 'Settings', 'restaurant-elementor' ); ?></a>
						</li>
					</ul>
				</nav>
