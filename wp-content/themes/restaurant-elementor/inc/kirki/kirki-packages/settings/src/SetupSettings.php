...
class SetupSettings {
	...
	public function submenu_page() {
		...
		add_submenu_page(
			'options-general.php',
			__( 'Kirki Customizer Framework', 'restaurant-elementor' ),
			__( 'Kirki', 'restaurant-elementor' ),
	...
	public function clear_font_cache() {
		...
		if ( is_dir( $fonts_dir ) ) {
			...
			wp_send_json_error( 'No local fonts found.', 'restaurant-elementor' );
		}

		wp_send_json_success( 'Font cache cleared.', 'restaurant-elementor' );
