	...
	public function filter_control_args( $args, $wp_customize ) {
		if ( $args['settings'] === $this->args['settings'] ) {
			...
			$args['button_labels'] = wp_parse_args(
				$args['button_labels'],
				[
					'select'       => esc_html__( 'Select image', 'restaurant-elementor' ),
					'change'       => esc_html__( 'Change image', 'restaurant-elementor' ),
					'default'      => esc_html__( 'Default', 'restaurant-elementor' ),
					'remove'       => esc_html__( 'Remove', 'restaurant-elementor' ),
					'placeholder'  => esc_html__( 'No image selected', 'restaurant-elementor' ),
					'frame_title'  => esc_html__( 'Select image', 'restaurant-elementor' ),
					'frame_button' => esc_html__( 'Choose image', 'restaurant-elementor' ),
				]
			);
