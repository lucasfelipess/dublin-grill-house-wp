...
class Dimensions extends Field {
	...
	public function init( $args = array() ) {
		...
		$labels = array(
			...
			'font-size'      => esc_html__( 'Font Size', 'restaurant-elementor' ),
			'font-weight'    => esc_html__( 'Font Weight', 'restaurant-elementor' ),
			'line-height'    => esc_html__( 'Line Height', 'restaurant-elementor' ),
			'font-style'     => esc_html__( 'Font Style', 'restaurant-elementor' ),
			'letter-spacing' => esc_html__( 'Letter Spacing', 'restaurant-elementor' ),
			'word-spacing'   => esc_html__( 'Word Spacing', 'restaurant-elementor' ),
			'top'            => esc_html__( 'Top', 'restaurant-elementor' ),
			'bottom'         => esc_html__( 'Bottom', 'restaurant-elementor' ),
			...
			'size'           => esc_html__( 'Size', 'restaurant-elementor' ),
			'spacing'        => esc_html__( 'Spacing', 'restaurant-elementor' ),
			'width'          => esc_html__( 'Width', 'restaurant-elementor' ),
			'height'         => esc_html__( 'Height', 'restaurant-elementor' ),
			'invalid-value'  => esc_html__( 'Invalid Value', 'restaurant-elementor' ),
		);
