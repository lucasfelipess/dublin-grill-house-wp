		...
		<div class="icons-wrapper">
			...
			<# } else { #>
				...
				var dashiconSections = {
					'admin-menu': '<?php esc_html_e( 'Admin Menu', 'restaurant-elementor' ); ?>',
					'welcome-screen': '<?php esc_html_e( 'Welcome Screen', 'restaurant-elementor' ); ?>',
					'post-formats': '<?php esc_html_e( 'Post Formats', 'restaurant-elementor' ); ?>',
					'media': '<?php esc_html_e( 'Media', 'restaurant-elementor' ); ?>',
					'image-editing': '<?php esc_html_e( 'Image Editing', 'restaurant-elementor' ); ?>',
					'tinymce': 'TinyMCE',
					'posts': '<?php esc_html_e( 'Posts', 'restaurant-elementor' ); ?>',
					'sorting': '<?php esc_html_e( 'Sorting', 'restaurant-elementor' ); ?>',
					'social': '<?php esc_html_e( 'Social', 'restaurant-elementor' ); ?>',
					'wordpress_org': 'WordPress',
					'products': '<?php esc_html_e( 'Products', 'restaurant-elementor' ); ?>',
					'taxonomies': '<?php esc_html_e( 'Taxonomies', 'restaurant-elementor' ); ?>',
					'widgets': '<?php esc_html_e( 'Widgets', 'restaurant-elementor' ); ?>',
					'notifications': '<?php esc_html_e( 'Notifications', 'restaurant-elementor' ); ?>',
					'misc': '<?php esc_html_e( 'Miscelaneous', 'restaurant-elementor' ); ?>'
				};
				#>
