...
(function ($) {
  var CleaningElementorWooLib = {
    ...
    OffCanvas: function () {
      var off_canvas_wrapper = $(".restaurant-elementor-off-canvas-sidebar-wrapper");
      var opn_shop_offcanvas_filter_close = function () {
        $("html").css({
          overflow: "",
          "margin-right": "",
        });
        $("html").removeClass("restaurant-elementor-enabled-overlay");
      };
      ...
      $(document).on("click", "." + trigger_class, function (e) {
        ...
        $("html").addClass("restaurant-elementor-enabled-overlay");
      });
    ...
    cartDropdown: function () {
      ...
      $(document).on("click", ".ajax_add_to_cart", function (e) {
        ...
        e.preventDefault();
        var data1 = {
          action: "restaurant_elementor_product_count_update",
        };
        $.post(
      ...
      $(document).on("click", "a.remove", function (e) {
        ...
        var data = {
          ...
          action: "restaurant_elementor_product_remove",
        };
        $.post(
          woocommerce_params.ajax_url, // The AJAX URL
    ...
    AutoCompleteSearch: function () {
      ...
      function autoComplete(e) {
        ...
        if (searchVal && searchVal.length >= 2) {
          ...
          let dataToAjx = {
            action: "restaurant_elementor_search_site",
            match: searchVal,
            cat: cat_,
          };
          //   return;
    ...
    CategoryTabFilter: function () {
      //product slider
      if (bizEcommerce.restaurant_elementor_single_row_slide_cat == true) {
        var sliderow = false;
      } else {
        var sliderow = true;
      }
      // slide autoplay
      if (bizEcommerce.restaurant_elementor_cat_slider_optn == true) {
        var cat_atply = true;
      } else {
        var cat_atply = false;
      }
      if (bizEcommerce.restaurant_elementor_rtl == true) {
        var bzecm_rtl = true;
      } else {
        var bzecm_rtl = false;
      }
      ...
      $(document).on(
        ...
        function (e) {
          ...
          $.ajax({
            ...
            url: bizEcommerce.ajaxUrl,
            data: {
              action: "restaurant_elementor_cat_filter_ajax",
...
('img.attachment-woocommerce_thumbnail').attr("srcset", src );
    ...
    ProductSlide: function () {
      if (bizEcommerce.restaurant_elementor_single_row_prdct_slide == true) {
        var sliderow_p = false;
      } else {
        var sliderow_p = true;
      }
      // slide autoplay
      if (bizEcommerce.restaurant_elementor_product_slider_optn == true) {
    ...
    ProductListSlide: function () {
      if (bizEcommerce.restaurant_elementor_single_row_prdct_list == true) {
      ...
      // slide autoplay
      if (bizEcommerce.restaurant_elementor_product_list_slide_optn == true) {
    ...
    CategorySlider: function () {
      // slide autoplay
      if (bizEcommerce.restaurant_elementor_category_slider_optn == true) {
      ...
      var column_no = parseInt(bizEcommerce.restaurant_elementor_cat_item_no);
    ...
    ProductImageTabFilter: function () {
      //product slider
      if (bizEcommerce.restaurant_elementor_product_img_sec_single_row_slide == true) {
        var sliderow = false;
      } else {
        var sliderow = true;
      }
      // slide autoplay
      if (bizEcommerce.restaurant_elementor_product_img_sec_slider_optn == true) {
        var cat_atply = true;
      } else {
        var cat_atply = false;
      }
      ...
      if (bizEcommerce.restaurant_elementor_product_img_sec_adimg == "") {
