<?php if (has_post_thumbnail() ){ ?>
    <div class="wpdevart-images-hover-effect">
        <a href="<?php the_permalink(); ?>"> 
            <div class="<?php echo esc_attr( get_theme_mod( 'wpdevart_restaurant_wda_posts_list_images_hover_effect' ) ); ?>"> 
...
<h2 class="post-list-title"><a href="<?php the_permalink(); ?>"><?php if( empty( $post->post_title ) ) { echo esc_html__( 'No Title', 'restaurant-wda'); } else { echo esc_html(wp_trim_words(get_the_title(), 4)); } ?></a></h2>
</div>
<div class="wpdevart-entry-meta">
    <?php echo esc_html(get_the_date('F j, Y')); ?>
	<svg width="20" height="19" class="wpdevart-icon-padding" x="0px" y="0px" viewBox="0 0 24 27" enable-background="new 0 0 22 32" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
	...
	<svg width="20" height="19" class="wpdevart-icon-padding" x="0px" y="0px" viewBox="0 0 24 27" enable-background="new 0 0 24 27" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
