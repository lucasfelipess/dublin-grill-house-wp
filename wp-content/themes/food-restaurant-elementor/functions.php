...
if (!function_exists('food_restaurant_elementor_enqueue_scripts')) {
	...
	function food_restaurant_elementor_enqueue_scripts() {
		...
		wp_style_add_data('food-restaurant-elementor-style', 'rtl', 'replace');
	...
	echo '<div class="notice notice-info wpele-activation-notice is-dismissible">';
		echo '<div class="notice-body">';
			echo '<div class="notice-content">';
				...
				echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=food_restaurant_elementor_about' ) ) .'" class="button button-notice">'. esc_html__( 'GET STARTED', 'food-restaurant-elementor' ) .'</a></span>';
				echo '<span><a href="'. esc_url( FOOD_RESTAURANT_ELEMENTOR_BUY_NOW ) .'" class="button button-notice" target="_blank" >'. esc_html__( 'BUY NOW', 'food-restaurant-elementor' ) .'</a></span>';
				echo '<span><a href="'. esc_url( FOOD_RESTAURANT_ELEMENTOR_LIVE_DEMO ) .'" class="button button-notice" target="_blank" >'. esc_html__( 'DEMO', 'food-restaurant-elementor' ) .'</a></span>';
			echo '</div>';
...
function food_restaurant_elementor_enqueue_setting() {
...
add_action('after_setup_theme', 'food_restaurant_elementor_enqueue_setting');
?>